...
const storeCustomer = () => {
  Inertia.post(route('customers.index'), form)
}
</script>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                  <section class="text-gray-600 body-font relative">
                    <form @submit.prevent="storeCustomer" action="post">
                          ...
                          <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full">
                              <div class="relative">
                                ...
                                <label for="gender9" class="leading-7 text-sm text-gray-600">男</label>
                                <input type="radio" id="gender" name="gender" v-model="form.gender" value="0">
                                <label for="gender1" class="leading-7 text-sm text-gray-600">女</label>
